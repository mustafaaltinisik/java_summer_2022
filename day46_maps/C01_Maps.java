...
public class C01_Maps {
    public static void main(String[] args) {
        ...
        // Tum ogrencilerin isimlerini ve soyisimlerini sira no ile
        // alt alta yazdirin
        Collection<String> tumValueColl = sinifList.values();
        String [] eachArr ;
        int sira = 1;
        for (String each: tumValueColl) {
            //yazdirirsak buradaki each bize her bir ogrenciye ait
            // ayni yapidaki isim, soyisim, brans bilgilerini iceren
            // String'ler getiriyor
            eachArr = each.split(", ");
            System.out.println(sira + "- " + eachArr[0] + " " + eachArr[1]);  // 1- Ali Can
            sira++;                                                           // 2- Enes Cem
            //3- Taha Emre
            //4- Derya Deniz
        }
