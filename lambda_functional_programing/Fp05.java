...
public class Fp05 {
    public static void main(String[] args) {
        ...
        System.out.println("herHangiBirKursAdiVerilenKelimeyiIceriyorMu : " + herHangiBirKursAdiVerilenKelimeyiIceriyorMu(coursesList, "turkisch "));
    ...
    private static void ortalamasıEnYuksekKursunAdiniYazdir(List<Courses> coursesList) {
    }
